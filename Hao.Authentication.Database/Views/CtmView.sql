...
/****** Object:  View [dbo].[CtmView]    Script Date: 2022/5/26 18:53:07 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[CtmView] AS SELECT C.Id,FR.FileName AS Avatar,C.Name,C.Nickname,CTT.Limited,CL.CreatedAt AS LastLoginAt, C.Remark,C.CreatedAt
FROM Customer AS C 
