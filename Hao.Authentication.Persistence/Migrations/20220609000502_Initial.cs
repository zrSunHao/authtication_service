        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SysId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramCustomerRelation", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    SysId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    PgmId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramCustomerRelation_CustomerId",
                table: "ProgramCustomerRelation",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramCustomerRelation_ProgramId",
                table: "ProgramCustomerRelation",
                column: "ProgramId");
